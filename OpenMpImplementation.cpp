...
void asyncUpdateAffectedVertices(const Graph& g, SSSPTree& tree, int async_level) {
    bool changed;
...
int main(int argc, char* argv[]) {
    ...
    // Update SSSP using all four algorithms
    ...
    if (use_async) {
        // Algorithm 4: Asynchronous update
        asyncUpdateAffectedVertices(g, initialTree, async_level);
    } else {
        // Algorithm 3: Synchronous update
